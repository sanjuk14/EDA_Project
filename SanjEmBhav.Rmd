...
plot(lmn$residual~lms$residual)
#The linearity of this graph shows us that the inclusion of poverty is worthwhile because it assists with the unexplained variability in the age variable.
```
